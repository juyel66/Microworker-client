...
const Navbar = () => {
  ...
  const links = (
    <>
     ...
     <li><NavLink className={({ isActive }) => isActive? "bg-gray-500 text-white btn-success text-bold text-[14px]": "text-[14px] font-bold lg:text-white text-black " } to='https://www.facebook.com/share/v/19DsoQTAQ8/' target="_blank" >Watch Demo</NavLink>
      </li>
