    ...
    <div>
      {!showDetails ? (
        <div className="text-5xl text-center mt-[300px] font-bold">
          <div className="flex justify-center text-center animate-spin">
            {" "}
            <IoReloadSharp />
          </div>
          <Countdown
              ...
              <div className="text-center">
                <form onSubmit={handleSubmit}>
                  <div className="justify-center hidden lg:flex">
                    <div>
                      <label className="font-bold" htmlFor="submission_details">
                        Submission Details:
                      </label>
                      <br />
                      <textarea
                  ...
                  <div className="flex lg:hidden">
                    ...
                    <textarea
                      rows={2}
                      className="bg-gray-200 border-2 border-gray-900 ml-14 rounded-xl"
                      id="submission_details"
                      required
                      placeholder="Submission Details"
                      value={submissionDetails}
                  ...
                  <button
                    className="btn w-full bg-[#5d386f] text-xl text-[#ACC7B4]"
                    type="submit"
                  >
                    Submit
                  </button>
